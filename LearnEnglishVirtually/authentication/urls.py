...
urlpatterns = [
    ...
    path('password_reset_complete/', auth_views.PasswordResetCompleteView.as_view(template_name='html/password_reset_complete.html'),name='password_reset_complete'), #password successfully changed message
